...
function Post({ user, post, onLike }) {

    const [isLiked, setIsliked] = useState(post.isLiked)
    console.log(post.isLiked +"yoyoyo")
        ...
        <div className="post">
            <div className="user">
                <div className="img-wrapper">
                    <img src={user.profilePic} alt="nopic" />
                </div>
                <p>{user.username}</p>
            </div>
